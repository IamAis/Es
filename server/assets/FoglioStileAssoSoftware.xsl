	...
	<xsl:choose>
      <xsl:when test="$Natura">
		...
		<xsl:if test="number($IVA)" >
			<br/><xsl:value-of select="format-number($IVA, '#.##0,00')" />
		</xsl:if>
      </xsl:when>
      <xsl:otherwise>
        <xsl:if test="$IVA">
          <xsl:value-of select="format-number($IVA, '#.##0,00')" />
        </xsl:if>
      </xsl:otherwise>
    </xsl:choose>
  </xsl:template>
              ...
              <xsl:if test=" translate( TipoDato,
                ...
                <xsl:if test="RiferimentoNumero">
                  <div class="tx-xsmall">
                    ...
                    <xsl:value-of select="format-number(RiferimentoNumero, '#.##0,00')" />
                  </div>
                </xsl:if>
              </xsl:if>
            </xsl:for-each>
          ...
          <td class="import2" >
            <xsl:if test="Quantita">
              <xsl:if test="number(Quantita)">
                <xsl:value-of select="format-number(Quantita, '#.##0,00')" />
              </xsl:if>
            </xsl:if>
          </td>
          <td class="import" >
        ...
        <tr>
          ...
          <td class="import" >
            <xsl:if test="AliquotaRitenuta">
              <xsl:value-of select="format-number(AliquotaRitenuta, '#.##0,00')" />
            </xsl:if>
          </td>
          <td >
          ...
          <td class="import" >
            <xsl:if test="ImportoRitenuta">
              <xsl:value-of select="format-number(ImportoRitenuta, '#.##0,00')" />
            </xsl:if>
          </td>
        </tr>
  </xsl:template>
  <xsl:template match="DettaglioPagamento">
    ...
    <xsl:if test="DataLimitePagamentoAnticipato or ScontoPagamentoAnticipato">
      ...
      <xsl:if test="ScontoPagamentoAnticipato">
        Sconto anticipato
        <xsl:value-of select="format-number(ScontoPagamentoAnticipato, '#.##0,00')" />
      </xsl:if>
      <br/>
    </xsl:if>
    <xsl:if test="DataDecorrenzaPenale or PenalitaPagamentiRitardati">
      ...
      <xsl:if test="PenalitaPagamentiRitardati">
        Importo penale
        <xsl:value-of select="format-number(PenalitaPagamentiRitardati, '#.##0,00')" />
      </xsl:if>
      <br/>
    </xsl:if>
                    ...
                    <tr>
                      ...
                      <td class="import" >
                        <xsl:if test="DatiIVA/Imposta">
                          <xsl:value-of select="format-number(DatiIVA/Imposta, '#.##0,00')" />
                        </xsl:if>
                      </td>
                      <td class="import" >
                        <xsl:call-template name="FormatIVA">
                      ...
                      <tr>
                        ...
                        <td class="import">
                          <xsl:if test="ImponibileCassa">
                            <xsl:value-of select="format-number(ImponibileCassa, '#.##0,00')" />
                          </xsl:if>
                        </td>
                        <td class="import">
                          <xsl:if test="AlCassa">
                            <xsl:value-of select="format-number(AlCassa, '#.##0,00')" />
                          </xsl:if>
                        </td>
                        <td  class="Ritenuta" >
                          ...
                          <xsl:choose>
                            ...
                            <xsl:otherwise>
                              <xsl:if test="AliquotaIVA">
                                <xsl:value-of select="format-number(AliquotaIVA, '#.##0,00')" />
                              </xsl:if>
                            </xsl:otherwise>
                          </xsl:choose>
                        </td>
                        <td class="import">
                          <xsl:if test="ImportoContributoCassa">
                            <xsl:value-of select="format-number(ImportoContributoCassa, '#.##0,00')" />
                          </xsl:if>
                        </td>
                      </tr>
                    </xsl:for-each>
                      ...
                      <tr>
                        ...
                        <td class="import">
                          <xsl:if test="SpeseAccessorie">
                            <xsl:value-of select="format-number(SpeseAccessorie, '#.##0,00')" />
                          </xsl:if>
                        </td>
						 <td class="import">
                        ...
                        <td  colspan="2" class="import" >
                          <xsl:if test="ImponibileImporto">
                            <xsl:value-of select="format-number(ImponibileImporto, '#.##0,00')" />
                          </xsl:if>
                        </td>
                        <td colspan="2"  class="import" >
                          <xsl:if test="Imposta">
                            <xsl:choose>
                              ...
                              <xsl:otherwise>
                                <xsl:value-of select="format-number(Imposta, '#.##0,00')" />
                              </xsl:otherwise>
                            </xsl:choose>
                          </xsl:if>
                        </td>
                  ...
                  <tr >
                    <td colspan="2" class="import" >
					 <xsl:if test="DatiGenerali/DatiGeneraliDocumento/DatiBollo">
						...
						<xsl:when test="DatiGenerali/DatiGeneraliDocumento/DatiBollo/ImportoBollo">
							<xsl:value-of select="format-number(DatiGenerali/DatiGeneraliDocumento/DatiBollo/ImportoBollo, '#.##0,00')" />
						</xsl:when>
					...
					<td class="import">
                      <xsl:if test="DatiGenerali/DatiGeneraliDocumento/Arrotondamento">
                        <xsl:value-of select="format-number(DatiGenerali/DatiGeneraliDocumento/Arrotondamento, '#.##0,00')" />
                      </xsl:if>
                    </td>
                    <td colspan="4" class="import">
                      <xsl:if test="DatiGenerali/DatiGeneraliDocumento/ImportoTotaleDocumento">
                        <xsl:value-of select="format-number(DatiGenerali/DatiGeneraliDocumento/ImportoTotaleDocumento, '#.##0,00')" />
                      </xsl:if>
                    </td>
                  </tr>
                  <!-- FINE Importo Totale  -->
                      ...
                      <tr>
                        ...
                        <td class="import">
                          <xsl:if test="ImportoPagamento">
                            <xsl:value-of select="format-number(ImportoPagamento, '#.##0,00')" />
                          </xsl:if>
                        </td>
                      </tr>
                    </xsl:for-each>
